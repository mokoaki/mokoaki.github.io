...
- トップレベルでメソッドを定義する、
  ...
  - つまり「Objectクラスのインスタンスである main にメソッドを定義する」という事
  - 通常は privateメソッドとして定義される
    - ちなみに **irb では purblicメソッドになる**ので注意
  - あまり重要ではないかもしれないが、Object のインスタンスにメソッドを定義するという事は
  - 全てのオブジェクトにメソッドを追加したのと同じという事でもある

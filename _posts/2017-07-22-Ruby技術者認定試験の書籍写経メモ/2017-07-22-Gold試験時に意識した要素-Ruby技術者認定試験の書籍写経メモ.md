...
- alias
  ...
  - 文字列は指定できない
- Module#alias_method
  - Module は Classクラスのスーパークラスなので、クラス定義の中で Module#alias_method が呼び出せる（同じようなメソッドはいっぱいある）
...
- undef
  ...
  - 文字列は指定できない
- Module#undef_method
  - Module は Classクラスのスーパークラスなので、クラス定義の中で Module#undef_method が呼び出せる（同じようなメソッドはいっぱいある）
  - undef_method メソッド名
  - 複数指定できる カンマが要る
  - シンボルか文字列で指定する
  - 直接メソッド名は指定できない
...
- Module は Classクラスのスーパークラスなので、クラス定義の中で Module#remove_method が呼び出せる（同じようなメソッドはいっぱいある）
- remove_method メソッド名
- 複数指定できる カンマが要る
- シンボルか文字列で指定する
- 直接メソッド名は指定できない

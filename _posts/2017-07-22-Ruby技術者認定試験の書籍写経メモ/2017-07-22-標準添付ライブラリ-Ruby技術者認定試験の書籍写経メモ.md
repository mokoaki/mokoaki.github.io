...
#### assert_equal(expected, actual, message = nil) assert_not_equal(expected, actual, message = nil)

- expectedに期待する値、actualに検証対象の値を渡す
- assert_equal は expected == actual の時に検証が成功する
- assert_not_equal は expected != actual の時に検証が成功する
...
#### assert_nil(object, message = nil) assert_not_nil(object, message = nil)

- assert_nil は object が nil であれば検証が成功する
- assert_not_nil は object が nil でなければ検証が成功する
...
#### assert_match(pattern, string, message = nil) assert_not_match(pattern, string, message = nil)

patternに指定した正規表現がstringにマッチすすなら検証が成功する

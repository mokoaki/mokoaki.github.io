...
- 直後にincludeにてModule1を参照、'./module.rb' が読み込まれモジュールが定義され、includeされる
...
- Module1が参照されたら './module.rb' を読み込むように設定
- Moko.new.hageメソッドが呼び出されるが、includeされていない為にメソッドが見つからない
- :Module1がオートロード対象かどうか表示、オートロード対象の為 "./module.rb" が表示される
- includeにてModule1を参照、'./module.rb' が読み込まれモジュールが定義され、includeされる

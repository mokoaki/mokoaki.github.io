...
[Hash]({% post_url 2017-07-22-Hash %}) の辺りも重要
...
- 内側から参照、変更ができる
- やる気になれば外部からもさわれる
- [変数、定数、予約語、再定義できない演算子]({% post_url 2017-07-22-変数、定数、予約語、再定義できない演算子 %}#インスタンス変数) の辺りにもちょっと書いてある
...
インスタンス変数へアクセスする専用のメソッドみたいな [変数、定数、予約語、再定義できない演算子]({% post_url 2017-07-22-変数、定数、予約語、再定義できない演算子 %}#インスタンス変数)

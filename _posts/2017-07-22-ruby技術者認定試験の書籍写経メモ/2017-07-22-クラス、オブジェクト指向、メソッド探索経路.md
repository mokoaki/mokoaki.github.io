...
- オブジェクト外から確認する事ができます
- インスタンスメソッドはどこに存在するのかというと、クラスに存在する、
- インスタンス変数はどこに存在するのかというと、オブジェクトに存在するのでしたね

| クラス#instance_methods           |
| クラス#public_instance_methods    |
| クラス#protected_instance_methods |
| クラス#private_instance_methods   |
